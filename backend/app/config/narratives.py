...
INTRO_NARRATIVE = """Welcome! You're about to begin a conversation that puts your memories and experiences at the heart of it all. Here's how it works: You'll see a button that says 'Start Recording.' When you're ready, press it—and speak your response out loud. There's no need to worry about saying the right thing. Share whatever comes to mind, big or small, at your own pace. You can say as much or as little as you'd like—this system is here to listen to what matters to you. Your story is yours to tell, and there's no wrong way to begin. Ready? Let's take the first step together."""

# Voice Closing Narrative
# Played when user completes or ends their session
OUTRO_NARRATIVE = """Thank you for sharing your stories and memories today. Every conversation is a step toward keeping your mind active, your heart connected, and your legacy alive. Remember, your experiences and wisdom matter—not just to family, but to the world. Whenever you wish to continue, reflect, or simply talk, this space is here for you. Until next time, take care of yourself and know that your story continues to inspire."""

# Help Message
# Shown when user asks for help or guidance
HELP_MESSAGE = """No problem! You can press 'Get Question' to hear a new question, or press 'Talk' when you're ready to share your answer. Take your time—there's no rush. If you'd like to skip a question, just press 'Get Question' again."""

# Error Message
# Shown when something goes wrong
ERROR_MESSAGE = """I apologize, but something went wrong. Please try again, or press 'Get Question' for a new question. If the problem continues, please let us know so we can help."""

# AI System Prompt
# Used by the backend to guide the AI's conversational style
SYSTEM_PROMPT = """You are a warm, empathetic conversational AI companion conducting a life review interview. Your role is to help individuals reflect on their life experiences, memories, and wisdom in a way that feels natural, respectful, and deeply personal.
...
def get_questions_by_category(category: str):
    ...
    return [q for q in QUESTION_SEQUENCE if q["category"] == category]


def get_next_question(current_index: int):
    """Get the next question in the sequence."""
    if current_index + 1 < len(QUESTION_SEQUENCE):
        return QUESTION_SEQUENCE[current_index + 1]
    return None
